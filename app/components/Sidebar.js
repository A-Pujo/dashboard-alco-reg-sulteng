    ...
    return(
        <aside className={`fixed inset-y-0 overflow-y-auto left-0 w-64 bg-base-300 text-black transform ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full'} lg:relative lg:translate-x-0 transition-transform duration-300 ease-in-out z-40 lg:z-auto`}>
            <div className="p-6 flex items-center justify-between border-b border-gray-300">
                <div>
                    ...
                    <div className='flex'>
                        ...
                        <img src='/assets/img/icon_title_alco_reg.png' className='w-8 self-center ml-4' />
                    </div>
                </div>
            ...
            <nav className="mt-8 mb-2 h-3/4">
                ...
                <Link href="/fiskal"
                    className={`flex items-center px-6 py-3 text-base-content ${activePLink == `fiskal` && `bg-base-200`} hover:bg-base-200 hover:text-base-content rounded-l-full transition-colors duration-200 mt-2`}
                    onClick={() => {
                ...
                <Link href="/ekonomi" 
                    className={`flex items-center px-6 py-3 text-base-content ${activePLink == `ekonomi` && `bg-base-200`} hover:bg-base-200 hover:text-base-content rounded-l-full transition-colors duration-200 mt-2`}
                    onClick={() => {
